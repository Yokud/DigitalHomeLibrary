namespace DigitalHomeLibrary.BookService.Domain.ValueObjects
{
    ...
    {
        public BookDetails(string title, string description, IEnumerable<Guid> authorIds, int releaseYear, string publisher, ISBN isbn, string genre, string language)
        {
        ...
        public IReadOnlyList<Guid> AuthorIds { get; }
