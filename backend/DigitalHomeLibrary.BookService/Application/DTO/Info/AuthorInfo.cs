...
namespace DigitalHomeLibrary.BookService.Application.DTO.Info
{
    ...
    {
        public static AuthorInfo FromDomainEntity(Author author) => new(author.FullName.FirstName, author.FullName.MiddleName, author.FullName.LastName, author.BirthDate, author.DeathDate, author.LifeStory, author.Country.Name);
